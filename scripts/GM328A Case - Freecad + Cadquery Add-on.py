...
class mkdsn():
    ...
    def __init__(self, board, clearance_xy):
        ...
        self.p3 = bd.Vector( -(board.d.X+clearance_xy)/2 + self.d.X/2 + 1*0, (board.d.Y+clearance_xy)/2 - self.d.Y/2 - 10.2)
        return None
...
s2 = y.wall_solid()
s3 = y.bottom_solid()
s4 = y.top_fillet_solid()
s5 = y.bottom_fillet_solid()
s0 = y.board_solid()

px = bd.Vector(-(78.7/2+26/2 + 20), 0, 0)
b0 = bd.Pos(px.X, 0, shell+clearance_z+17/2) * battery().solid()
b1 = bd.Pos(px) * x.top_solid()
b2 = bd.Pos(px) * x.wall_solid()
b3 = bd.Pos(px) * x.bottom_solid()
b4 = bd.Pos(px) * x.top_fillet_solid()
b5 = bd.Pos(px) * x.bottom_fillet_solid()


# -----------------------------------------------------------------------------------
# transfer from b3d to cq
cq_solid0 = cq.Solid.makeBox(1,1,1)
cq_solid1 = cq.Solid.makeBox(1,1,1)
cq_solid2 = cq.Solid.makeBox(1,1,1)
cq_solid3 = cq.Solid.makeBox(1,1,1)
cq_solid4 = cq.Solid.makeBox(1,1,1)
cq_solid5 = cq.Solid.makeBox(1,1,1)

cq_solid0.wrapped = s0.solid().wrapped
cq_solid1.wrapped = s1.solid().wrapped
cq_solid2.wrapped = s2.solid().wrapped
cq_solid3.wrapped = s3.solid().wrapped
cq_solid4.wrapped = s4.solid().wrapped
cq_solid5.wrapped = s5.solid().wrapped


cq_solid10 = cq.Solid.makeBox(1,1,1)
cq_solid11 = cq.Solid.makeBox(1,1,1)
cq_solid12 = cq.Solid.makeBox(1,1,1)
cq_solid13 = cq.Solid.makeBox(1,1,1)
cq_solid14 = cq.Solid.makeBox(1,1,1)
cq_solid15 = cq.Solid.makeBox(1,1,1)

cq_solid10.wrapped = b0.solid().wrapped
cq_solid11.wrapped = b1.solid().wrapped
cq_solid12.wrapped = b2.solid().wrapped
cq_solid13.wrapped = b3.solid().wrapped
cq_solid14.wrapped = b4.solid().wrapped
cq_solid15.wrapped = b5.solid().wrapped


# return cadquery object instead of OCCP one
result0 = cq.Workplane(obj=cq_solid0)
result1 = cq.Workplane(obj=cq_solid1)
result2 = cq.Workplane(obj=cq_solid2)
result3 = cq.Workplane(obj=cq_solid3)
result4 = cq.Workplane(obj=cq_solid4)
result5 = cq.Workplane(obj=cq_solid5)

result10 = cq.Workplane(obj=cq_solid10)
result11 = cq.Workplane(obj=cq_solid11)
result12 = cq.Workplane(obj=cq_solid12)
result13 = cq.Workplane(obj=cq_solid13)
result14 = cq.Workplane(obj=cq_solid14)
result15 = cq.Workplane(obj=cq_solid15)



show_object(result1, name='Lid', group='Box Group', rgba='#F0F0F000')
show_object(result2, name='Wall', group='Box Group', rgba='#F0F0F000')
show_object(result3, name='Base', group='Box Group', rgba='#F0F0F000')
show_object(result4, name='Top Fillet', group='Box Group', rgba='#E6FB0400')
show_object(result5, name='Bottom Fillet', group='Box Group', rgba='#E6FB0400')

show_object(result11, name='Battery_Lid', group='Box Group', rgba='#F0F0F000')
show_object(result12, name='Battery_Wall', group='Box Group', rgba='#F0F0F000')
show_object(result13, name='Battery_Base', group='Box Group', rgba='#F0F0F000')
show_object(result14, name='Battery_Top Fillet', group='Box Group', rgba='#E6FB0400')
show_object(result15, name='Battery_Bottom Fillet', group='Box Group', rgba='#E6FB0400')


print("Objects were created!")
